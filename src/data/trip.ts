...
export const TRIP = {
  ...
  launch: {
    ...
    site: 'Wenchang Space Launch Site · 文昌航天发射场',
    siteArea: 'Longlou Town, Wenchang · 文昌市龙楼镇',
  },
...
export const PLACES: Place[] = [
  ...
  { id: 'launch-pad', name: 'Launch Site', cn: '文昌航天发射场', lat: 19.613, lng: 110.951, kind: 'launch' },
