...
export const UI = {
  ...
  navPacking: { en: 'Packing', zh: '行李清单' },
  navSources: { en: 'Sources', zh: '资料来源' },

  // --------------------------------------------------------------- packing ---
  packEyebrow: { en: 'Packing', zh: '行李' },
  packTitle: { en: 'Packing checklist', zh: '打包清单' },
  packLede: {
    en: 'The family packing list, with the importance labels turned into colours. Tick items off as they go in the bag — your ticks are saved on this device, and the list works the same in Chinese.',
    zh: '全家人的打包清单，重要程度以文字颜色区分。装好一项就勾选一项，勾选状态保存在本机；切换中文后清单完全一致。',
  },
  packProgress: { en: '{done} of {total} packed', zh: '已打包 {done} / {total} 项' },
  packSubProgress: { en: '{left} left', zh: '还剩 {left} 项' },
  packAllDone: { en: 'Everything on the list is packed.', zh: '清单上的东西都打包好了。' },
  packItemsCount: { en: '{n} items', zh: '{n} 项' },
  packItemCount: { en: '1 item', zh: '1 项' },
  packHidePacked: { en: 'Hide packed', zh: '隐藏已勾选' },
  packShowPacked: { en: 'Show packed', zh: '显示已勾选' },
  packReset: { en: 'Untick everything', zh: '清除全部勾选' },
  packResetConfirm: { en: 'Tap again to confirm', zh: '再按一次确认清除' },
  packLegendTitle: { en: 'Colour shows importance', zh: '颜色代表重要程度' },
  packJump: { en: 'Jump to a list', zh: '跳转到清单' },
  packSectionDone: { en: 'complete', zh: '已完成' },
  packAmount: { en: 'How much', zh: '数量' },
  packTierMust: { en: 'Essential', zh: '必备' },
  packTierHigh: { en: 'Strongly recommended', zh: '强烈建议' },
  packTierUseful: { en: 'Useful', zh: '有用' },
  packTierOptional: { en: 'Optional', zh: '可选' },
  packTierBuy: { en: 'Buy on arrival', zh: '到达后购买' },
  packSource: {
    en: 'Item list, quantities and the safety notes come from your own packing list (packing-list.txt, 14 Sep 2026).',
    zh: '条目、数量与安全提示均来自你自己的打包清单（packing-list.txt，2026 年 9 月 14 日）。',
  },
